...
# csv_path = "../data/qa_pairs_update.csv"
...
# 保存处理结果（仅包含成功处理的数据）
# output_path = "../data/qa_pairs_update/rag_results_v3_re_bge-reranker-large.csv"
output_path = "../data/qa_pairs/rag_results_2776_v1_re_bge-reranker-large.csv"
